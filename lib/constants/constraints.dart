...
class AppConstraints {
  ...
  static EdgeInsets mx(double? space) {
    return EdgeInsets.only(left: space ?? 0, right: space ?? 0);
  }

  static EdgeInsets my(double? space) {
    return EdgeInsets.only(top: space ?? 0, bottom: space ?? 0);
  }
}
